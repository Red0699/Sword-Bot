/*
const { SlashCommandBuilder, ApplicationCommandOptionType, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle } = require('discord.js');
...
module.exports = {
    ...
    .setName("play")
    .setDescription("come one let's hear some music!!")
    .setOptions: [{
        name: 'name',
